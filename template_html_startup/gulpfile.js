...
gulp.task('watch', function () {
  ...
  gulp.watch('src/img/**', gulp.series(gulp.parallel(['img'])));
	...
	gulp.watch('src/data/*.json', gulp.series(gulp.parallel(['data'])));
	gulp.watch('src/data/*/*.json', gulp.series(gulp.parallel(['data'])));
});
...
gulp.task('default', gulp.series(gulp.parallel([ 'html', 'css-vendor', 'css-app', 'css-img', 'js-vendor', 'js-app', 'js-demo', 'img', 'fonts', 'watch', 'webserver', 'data' ])));